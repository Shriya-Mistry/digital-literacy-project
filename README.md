...
This project is focuses on developing skills required to use digital tools effectively. 

It aims to :
1. Enhance Technical Knowledge
2. Improve Online Communication
3. Spread Cybersecurity Awareness
...
│
├── task-1-presentation/
│   └── Digital_Literacy_Awareness_Infographic.pdf
│
├── task-2-portfolio/
│   ├── GitHub.pdf
│   ├── LinkedIn.pdf
